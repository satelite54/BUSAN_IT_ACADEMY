...
-- 트랜젝션 작업하기 (입력, 수정, 삭제)
INSERT INTO dept_tcl VALUES(50, 'DATADASE', 'SEOUL');
UPDATE dept_tcl SET LOC = 'busan' WHERE deptno = 40;
DELETE FROM dept_tcl WHERE dname = 'RESEARCH';

-- 변경사항 영구저장 -- 롤백하면 커밋했던 지점의 데이터로 변경
commit;
-- 커밋 없이 롤백하면 테이블 생성될 때의 데이터로 롤백
ROLLBACK; -- ROLLBACK TO c1  -- SAVEPOINT c1으로 롤백
-- 세이브 포인트랑 커밋이랑 차이가 뭐야
